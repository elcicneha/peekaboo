...
public enum FileTypeRegistry {
    ...
    private static let registry: [String: LanguageInfo] = [
        ...
        "sh":       .init(grammarSearch: "shell",             displayName: "Shell"),
        "bash":     .init(grammarSearch: "shell",             displayName: "Bash"),
        "zsh":      .init(grammarSearch: "shell",             displayName: "Zsh"),
        "ksh":      .init(grammarSearch: "shell",             displayName: "Korn Shell"),
